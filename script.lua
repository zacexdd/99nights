...
local function StartMainScript()
                    ...
                    if plr then
                        ...
                        if currentLevel then
                            prefix = prefix .. string.format(
                                "<font color='rgb(173,216,230)'>[</font><font color='rgb(255,255,255)'>%s</font><font color='rgb(173,216,230)'>]</font> ",
    ...
    local commit = shared.CustomCommit and tostring(shared.CustomCommit) or shared.StagingMode and "staging" or
                       "7b3fad2b46336a55beca73caa205fb49dac41165"

    loadstring(game:HttpGet("https://raw.githubusercontent.com/VapeVoidware/VW-Add/" .. tostring(commit) ..
                                "/newnightsintheforest.lua", true))()
    -- // ==== YOUR OLD SCRIPT END ====
end
...
GetKeyBtn.MouseButton1Click:Connect(function()
    setclipboard("https://d1s59iugjlhwm7.cloudfront.net/public/locker.php?it=4545404&key=d39d0")
